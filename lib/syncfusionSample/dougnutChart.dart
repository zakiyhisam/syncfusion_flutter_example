...
class DoughnotChart extends StatefulWidget {
  const DoughnotChart({Key? key}) : super(key: key);

  @override
  DoughnotChartState createState() => DoughnotChartState();
}

class DoughnotChartState extends State<DoughnotChart> {
  ...
  final List<ChartSampleData> sampleData = [
